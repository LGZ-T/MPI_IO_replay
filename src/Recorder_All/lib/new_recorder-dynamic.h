...
RECORDER_EXTERN_DECL(PMPI_Comm_free, int, (MPI_Comm *comm));
RECORDER_EXTERN_DECL(PMPI_Comm_dup, int, (MPI_Comm comm, MPI_Comm *newcomm));
RECORDER_EXTERN_DECL(PMPI_Comm_split, int, (MPI_Comm comm, int color, int key, MPI_Comm *newcomm));
...
RECORDER_EXTERN_DECL(PMPI_Type_struct, int, (int count, int *array_of_blocklengths, MPI_Aint *array_of_displacements, MPI_Datatype *array_of_types, MPI_Datatype *newtype));

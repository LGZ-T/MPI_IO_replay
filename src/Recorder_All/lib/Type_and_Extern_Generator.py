...
if __name__ == '__main__':
	...
	output_init_compress = open("init-compress.c", "w")
	
	before_init = open("Before_type")
	after_init = open("After_type")
	...
	before_extern = open("Before_extern")
	output_extern = open("new_recorder-dynamic.h", "w")

/* recorder-runtime-config.h.  Generated from recorder-runtime-config.h.in by configure.  */
/* recorder-runtime-config.h.in.  Generated from configure.in by autoheader.  */

/* Define if building universal (internal helper macro) */
/* #undef AC_APPLE_UNIVERSAL_BUILD */

/* Name of the environment variable that stores the jobid */
#define CP_JOBID "NONE"
...
#define PACKAGE_NAME "recorder-runtime"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "recorder-runtime 2.x"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "recorder-runtime"
...
#define __CP_LOG_PATH "/opt/recorder-Profile"

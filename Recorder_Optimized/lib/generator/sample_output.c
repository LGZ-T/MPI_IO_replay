...
int MPI_File_close(MPI_File *fh)
{
	...
	tm2 = recorder_wtime();
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_close fh=%d \n",  tm1, tm2, fh);
...
int MPI_File_set_size(MPI_File fh,MPI_Offset size)
{
	...
	tm2 = recorder_wtime();
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_set_size fh=%d size=%d \n",  tm1, tm2, fh, size);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_iread_at fh=%d offset=%d buf=*buf count=%d datatype=%s request=%d \n",  tm1, tm2, fh, offset, count, datatype_name, request);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_iread(MPI_File fh,void  *buf,int  count,MPI_Datatype  datatype,__D_MPI_REQUEST  *request)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_iread fh=%d buf=*buf count=%d datatype=%s request=%d \n",  tm1, tm2, fh, count, datatype_name, request);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_iread_shared(MPI_File fh,void *buf,int count,MPI_Datatype datatype,__D_MPI_REQUEST *request)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_iread_shared fh=%d buf=*buf count=%d datatype=%s request=%d \n",  tm1, tm2, fh, count, datatype_name, request);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_iwrite_at(MPI_File fh,MPI_Offset offset,void *buf,int count,MPI_Datatype datatype,__D_MPI_REQUEST *request)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_iwrite_at fh=%d offset=%d buf=*buf count=%d datatype=%s request=%d \n",  tm1, tm2, fh, offset, count, datatype_name, request);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_iwrite(MPI_File fh,void *buf,int count,MPI_Datatype datatype,__D_MPI_REQUEST *request)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_iwrite fh=%d buf=*buf count=%d datatype=%s request=%d \n",  tm1, tm2, fh, count, datatype_name, request);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_iwrite_shared(MPI_File fh,void *buf,int count,MPI_Datatype datatype,__D_MPI_REQUEST *request)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_iwrite_shared fh=%d buf=*buf count=%d datatype=%s request=%d \n",  tm1, tm2, fh, count, datatype_name, request);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
PMPI_Comm_get_name(comm, comm_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_open comm=%s filename=%s amode=%d info=%d fh=%d \n",  tm1, tm2, comm_name, filename, amode, info, fh);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_read_all_begin(MPI_File fh,void *buf,int count,MPI_Datatype datatype)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_read_all_begin fh=%d buf=*buf count=%d datatype=%s \n",  tm1, tm2, fh, count, datatype_name);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_read_all(MPI_File fh,void *buf,int count,MPI_Datatype datatype,MPI_Status *status)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_read_all fh=%d buf=*buf count=%d datatype=%s status=%d \n",  tm1, tm2, fh, count, datatype_name, status);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_read_at_all(MPI_File fh,MPI_Offset offset,void *buf,int count,MPI_Datatype datatype,MPI_Status *status)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_read_at_all fh=%d offset=%d buf=*buf count=%d datatype=%s status=%d \n",  tm1, tm2, fh, offset, count, datatype_name, status);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_read_at_all_begin(MPI_File fh,MPI_Offset offset,void *buf,int count,MPI_Datatype datatype)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_read_at_all_begin fh=%d offset=%d buf=*buf count=%d datatype=%s \n",  tm1, tm2, fh, offset, count, datatype_name);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_read_at(MPI_File fh,MPI_Offset offset,void *buf,int count,MPI_Datatype datatype,MPI_Status *status)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_read_at fh=%d offset=%d buf=*buf count=%d datatype=%s status=%d \n",  tm1, tm2, fh, offset, count, datatype_name, status);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_read(MPI_File fh,void *buf,int count,MPI_Datatype datatype,MPI_Status *status)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_read fh=%d buf=*buf count=%d datatype=%s status=%d \n",  tm1, tm2, fh, count, datatype_name, status);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_read_ordered_begin(MPI_File fh,void *buf,int count,MPI_Datatype datatype)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_read_ordered_begin fh=%d buf=*buf count=%d datatype=%s \n",  tm1, tm2, fh, count, datatype_name);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_read_ordered(MPI_File fh,void *buf,int count,MPI_Datatype datatype,MPI_Status *status)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_read_ordered fh=%d buf=*buf count=%d datatype=%s status=%d \n",  tm1, tm2, fh, count, datatype_name, status);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_read_shared(MPI_File fh,void *buf,int count,MPI_Datatype datatype,MPI_Status *status)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_read_shared fh=%d buf=*buf count=%d datatype=%s status=%d \n",  tm1, tm2, fh, count, datatype_name, status);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
PMPI_Type_get_name(filetype, filetype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_set_view fh=%d disp=%d etype=%s filetype=%s datarep=%s info=%d \n",  tm1, tm2, fh, disp, etype_name, filetype_name, datarep, info);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_sync(MPI_File fh)
{
	...
	tm2 = recorder_wtime();
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_sync fh=%d \n",  tm1, tm2, fh);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_write_all_begin(MPI_File fh,void *buf,int count,MPI_Datatype datatype)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_write_all_begin fh=%d buf=*buf count=%d datatype=%s \n",  tm1, tm2, fh, count, datatype_name);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_write_all(MPI_File fh,void *buf,int count,MPI_Datatype datatype,MPI_Status *status)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_write_all fh=%d buf=*buf count=%d datatype=%s status=%d \n",  tm1, tm2, fh, count, datatype_name, status);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_write_at_all_begin(MPI_File fh,MPI_Offset offset,void *buf,int count,MPI_Datatype datatype)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_write_at_all_begin fh=%d offset=%d buf=*buf count=%d datatype=%s \n",  tm1, tm2, fh, offset, count, datatype_name);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_write_at_all(MPI_File fh,MPI_Offset offset,void *buf,int count,MPI_Datatype datatype,MPI_Status *status)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_write_at_all fh=%d offset=%d buf=*buf count=%d datatype=%s status=%d \n",  tm1, tm2, fh, offset, count, datatype_name, status);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_write_at(MPI_File fh,MPI_Offset offset,void *buf,int count,MPI_Datatype datatype,MPI_Status *status)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_write_at fh=%d offset=%d buf=*buf count=%d datatype=%s status=%d \n",  tm1, tm2, fh, offset, count, datatype_name, status);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_write(MPI_File fh,void *buf,int count,MPI_Datatype datatype,MPI_Status *status)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_write fh=%d buf=*buf count=%d datatype=%s status=%d \n",  tm1, tm2, fh, count, datatype_name, status);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_write_ordered_begin(MPI_File fh,void *buf,int count,MPI_Datatype datatype)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_write_ordered_begin fh=%d buf=*buf count=%d datatype=%s \n",  tm1, tm2, fh, count, datatype_name);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_write_ordered(MPI_File fh,void *buf,int count,MPI_Datatype datatype,MPI_Status *status)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_write_ordered fh=%d buf=*buf count=%d datatype=%s status=%d \n",  tm1, tm2, fh, count, datatype_name, status);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_File_write_shared(MPI_File fh,void *buf,int count,MPI_Datatype datatype,MPI_Status *status)
{
	...
	tm2 = recorder_wtime();
PMPI_Type_get_name(datatype, datatype_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_File_write_shared fh=%d buf=*buf count=%d datatype=%s status=%d \n",  tm1, tm2, fh, count, datatype_name, status);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_Comm_rank(MPI_Comm comm,int *rank)
{
	...
	tm2 = recorder_wtime();
PMPI_Comm_get_name(comm, comm_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_Comm_rank comm=%s rank=*rank \n",  tm1, tm2, comm_name);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
...
int MPI_Comm_size(MPI_Comm comm,int *size)
{
	...
	tm2 = recorder_wtime();
PMPI_Comm_get_name(comm, comm_name, &result_len);
	bytes = sprintf(rec_buffer + written_bytes, "tm1=%ld tm2=%ld func=MPI_Comm_size comm=%s size=*size \n",  tm1, tm2, comm_name);
	read_func(sc, rec_buffer);
	write_or_compress(sc);
	return ret;
}
